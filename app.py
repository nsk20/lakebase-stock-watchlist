...
- Serves a Flask REST API for managing stock watchlists and historical price records
- Reads and writes to Databricks Lakebase (managed PostgreSQL instance)
- Integrates with the Massive API for live market data fetching
...
logger = logging.getLogger("stock-watchlist-app")
